...
id: "资产级细粒度验收技能"
title_zh: 资产级细粒度验收技能
title_en: Asset-Level Fine-Grained Acceptance Skill
status: active
project_id: ""
related_assets: []
source_paths: []
...
## 1. 技能目的
按资产类型逐项验收候选图并判定 accepted/rejected/rework。
...
## 4. 读取的唯一事实源字段
- asset_ontology、compiled_prompt、execution_telemetry、candidate_outputs、reference_dependencies
...
- 输出字段能回写到 story_core.visual_pipeline.asset_acceptance。
...
- visual_pipeline.asset_acceptance、blocked_actions

## 12. 必须检查的验收清单
- 资产级细粒度验收清单、R00/R01/R02/S页源插图验收清单
