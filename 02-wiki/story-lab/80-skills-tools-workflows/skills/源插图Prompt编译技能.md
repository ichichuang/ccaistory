...
type: skill_card
id: "源插图Prompt编译技能"
title_zh: 源插图Prompt编译技能
title_en: Source-Illustration Prompt Compile Skill
status: active
project_id: ""
related_assets: []
source_paths: []
...
runtime_commands: ["compile-asset"]
...
## 3. 输出
- 源插图Prompt编译 JSON、compiled_prompt
- machine_state 更新建议
- blocked_actions 或返修入口

## 4. 读取的唯一事实源字段
- visual_pipeline.asset_ontology、reference_dependencies、acceptance_questions
...
- 输出字段能回写到 story_core.visual_pipeline.compiled_prompts。
...
- visual_pipeline.compiled_prompts、machine_state
