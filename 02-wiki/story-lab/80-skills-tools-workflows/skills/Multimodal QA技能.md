...
- 对连载页追加 style continuity、character continuity、proportion continuity、previous-page scene continuity、environment progression、hook strength、annotation relevance、story-stage fit、safety 等人工 QA 项。
...
- 仅风格漂亮不能通过；候选必须像上一张 accepted 页面之后自然发生的下一页。
