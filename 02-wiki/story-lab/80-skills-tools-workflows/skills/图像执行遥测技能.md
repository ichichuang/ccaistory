...
id: "图像执行遥测技能"
title_zh: 图像执行遥测技能
title_en: Image Execution Telemetry / GenerationRun Backfill Skill
status: active
project_id: ""
related_assets: []
source_paths: []
...
version: v1
canonical: true
skill_category: generation_run_backfill
runtime_commands: ["validate-telemetry"]
...
## 4. 读取的唯一事实源字段
- compiled_prompt、actual_prompt_sent_to_external_tool、tool_config、candidate_outputs
...
- 输出字段能回写到 story_core.visual_pipeline.execution_telemetry。
...
- visual_pipeline.execution_telemetry、machine_state
