...
id: "人工完整阅读技能"
title_zh: 人工完整阅读技能
title_en: Manual Full-Read Skill
status: active
project_id: ""
related_assets: []
source_paths: []
...
## 4. 读取的唯一事实源字段
- publish_page、platform_story_pages、accepted_assets、quality_gates
...
- 输出字段能回写到 story_core.quality_gates.manual_full_reading。
...
- quality_gates.manual_full_reading、machine_state
