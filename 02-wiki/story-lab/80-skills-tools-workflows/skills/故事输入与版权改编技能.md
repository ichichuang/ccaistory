...
type: skill_card
id: "故事输入与版权改编技能"
title_zh: 故事输入与版权改编技能
title_en: Story Intake & Copyright Adaptation Skill
status: active
project_id: ""
related_assets: []
source_paths: []
...
## 3. 输出
- 故事输入摘要、版权边界说明、改编约束清单
- machine_state 更新建议
- blocked_actions 或返修入口

## 4. 读取的唯一事实源字段
- source_material、copyright_boundary、adaptation_policy、target_audience
...
- 输出字段能回写到 story_core.source_summary、story_core.copyright_boundary、story_core.adaptation_policy。
...
- 故事核心.json.source_summary、copyright_boundary、adaptation_policy
