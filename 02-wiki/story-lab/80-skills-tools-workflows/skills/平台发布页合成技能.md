...
id: "平台发布页合成技能"
title_zh: 平台发布页合成技能
title_en: Platform Publish-Page Synthesis Skill
status: active
project_id: ""
related_assets: []
source_paths: []
...
## 4. 读取的唯一事实源字段
- platform_story_pages、accepted_assets、publish_template
...
- 输出字段能回写到 story_core.publish_page。
