...
type: skill_card
id: "故事图扩展与连贯性审查技能"
title_zh: 故事图扩展与连贯性审查技能
title_en: Story-Graph Expansion & Continuity Skill
status: active
project_id: ""
related_assets: []
source_paths: []
...
version: v1
canonical: true
skill_category: story_rewrite
runtime_commands: ["check-graph", "analyze-graph"]
...
## 4. 读取的唯一事实源字段
- story_graph、technique_selection、continuity_constraints
...
- 输出字段能回写到 story_core.platform_story_graph、story_core.story_graph.continuity_notes。
...
- platform_story_graph、quality_gates.continuity
