...
id: "提示词生成技能"
title_zh: 提示词生成技能
title_en: Prompt Fragment Generation Skill (deprecated)
status: deprecated
project_id: ""
related_assets: []
source_paths: []
...
## 1. 技能目的
维护提示词片段生成边界，不替代 compiled_prompt 编译。
...
## 4. 读取的唯一事实源字段
- prompt_locks、asset_type、visual_rules、negative_constraints
...
- 输出字段能回写到 story_core.visual_pipeline.prompt_fragments。
...
- visual_pipeline.prompt_fragments

## 12. 必须检查的验收清单
- 源插图Prompt编译验收清单、负面约束
