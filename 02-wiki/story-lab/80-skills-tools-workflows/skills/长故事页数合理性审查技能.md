...
type: skill_card
id: "长故事页数合理性审查技能"
title_zh: 长故事页数合理性审查技能
title_en: Long-Story Page-Count Review Skill
status: active
project_id: ""
related_assets: []
source_paths: []
...
runtime_commands: ["estimate-pages"]
...
## 4. 读取的唯一事实源字段
- story_graph、target_platform、target_pages、audience_constraints
...
- 输出字段能回写到 story_core.quality_gates.long_story_page_count。
...
- quality_gates.long_story_page_count、machine_state
