...
id: "故事钩子强化技能"
title_zh: 故事钩子强化技能
title_en: Hook Reinforcement Skill
status: active
project_id: ""
related_assets: []
source_paths: []
...
runtime_commands: ["analyze-graph", "analyze-tension"]
...
## 3. 输出
- hook_scores、hook_revisions、低分钩子返修点
- machine_state 更新建议
- blocked_actions 或返修入口

## 4. 读取的唯一事实源字段
- story_graph.hooks、technique_selection、platform_story_graph
...
- 输出字段能回写到 story_core.story_graph.hook_scores、hook_revisions。
...
- story_graph.hook_scores、machine_state
