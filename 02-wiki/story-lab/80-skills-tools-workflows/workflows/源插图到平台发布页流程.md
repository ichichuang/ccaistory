...
type: workflow_card
id: "源插图到平台发布页流程"
title_zh: 源插图到平台发布页流程
title_en: Source-Illustration to Publish-Page Flow (deprecated clone)
status: deprecated
project_id: ""
related_assets: []
source_paths: []
...
stop_conditions: []
replacement_for: ""
deprecated_by: "L-Publishing-Readiness-Workflow"
---
# 源插图到平台发布页流程
...
## 1. 流程目标
把 accepted 源插图安全合成为平台发布页。

## 2. 输入
- accepted 资产、平台图文故事编排、资产验收报告。
- 总控/状态机与门禁.md
...
## 10. 下游入口
- 默认下游入口：[[00-system/codex-instructions/生成平台发布页排版方案]]
