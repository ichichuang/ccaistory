...
type: workflow_card
id: "外部出图工具出图窗口操作手册"
title_zh: 外部出图工具出图窗口操作手册
title_en: External Image-Tool Window Manual (deprecated clone)
status: deprecated
project_id: ""
related_assets: []
source_paths: []
...
stop_conditions: []
replacement_for: ""
deprecated_by: "G-WebGPTImage-Manual-Generation-Handoff-Workflow"
---
# 外部出图工具出图窗口操作手册
...
## 1. 流程目标
规定人工单张外部出图窗口的输入、记录和禁止事项。

## 2. 输入
- 通过 Lint 的 compiled_prompt 和试产任务清单。
- 总控/状态机与门禁.md
...
## 10. 下游入口
- 默认下游入口：[[00-system/codex-instructions/记录图像执行遥测]]
