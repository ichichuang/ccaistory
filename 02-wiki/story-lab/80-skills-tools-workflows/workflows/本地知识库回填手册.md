...
id: "本地知识库回填手册"
title_zh: 本地知识库回填手册
title_en: Local KB Backfill Manual (deprecated clone)
status: deprecated
project_id: ""
related_assets: []
source_paths: []
...
stop_conditions: []
replacement_for: ""
deprecated_by: "H-GenerationRun-Backfill-Workflow"
---
# 本地知识库回填手册
...
## 3. 输出
- story_core 中的 asset_results、repair_queue 和状态迁移。
...
## 10. 下游入口
- 默认下游入口：[[00-system/codex-instructions/回填源插图结果]]
