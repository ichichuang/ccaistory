...
type: workflow_card
id: "图像试产与连续性验证流程"
title_zh: 图像试产与连续性验证流程
title_en: Image Pilot & Continuity Verify Flow (deprecated clone)
status: deprecated
project_id: ""
related_assets: []
source_paths: []
...
stop_conditions: []
replacement_for: ""
deprecated_by: "I-Image-QA-and-Repair-Workflow"
---
# 图像试产与连续性验证流程
...
## 10. 下游入口
- 默认下游入口：[[00-system/codex-instructions/运行资产级细粒度验收]]
