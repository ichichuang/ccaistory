...
type: workflow_card
id: "新故事从输入到试产流程"
title_zh: 新故事从输入到试产流程
title_en: New-Story Input-to-Pilot Flow (deprecated clone)
status: deprecated
project_id: ""
related_assets: []
source_paths: []
...
stop_conditions: []
replacement_for: ""
deprecated_by: "A-Raw-Story-Intake-Workflow"
---
# 新故事从输入到试产流程
...
## 10. 下游入口
- 默认下游入口：[[00-system/codex-instructions/生成源插图试产任务清单]]
