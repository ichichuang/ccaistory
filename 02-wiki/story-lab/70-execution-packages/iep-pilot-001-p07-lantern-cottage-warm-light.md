...
id: iep-pilot-001-p07-lantern-cottage-warm-light
title_zh: pilot-001 p07 守灯小屋暖光图像执行包
title_en: pilot-001 p07 Lantern Cottage Warm Light Image Execution Package
status: ready
project_id: pilot-001
scene_id: scene-lantern-cottage
page_or_spread_range: p07
characters:
  - char-xiaohe
  - char-mama
...
compile_result_ref: "50-agent-work/story-lab/compiled-prompts/iep-pilot-001-p07-lantern-cottage-warm-light.json"
semantic_lint_result_ref: "50-agent-work/story-lab/semantic-lint-results/iep-pilot-001-p07-lantern-cottage-warm-light.json"
...
allowed_content:
  - "Small warm cottage light in the dark; Xiao He and Mama decide to ask for help."
  - "Lantern Grandpa may appear as a clearly warm, safe helper."
forbidden_content:
...
# pilot-001 p07 守灯小屋暖光图像执行包 / Lantern Cottage Warm Light Image Execution Package
...
Workflow F ready package plan for the p07 page illustration: the warm helper's cottage appears as the answer to asking for help. No image asset is created by this card.
...
- Warm glowing cottage window or open door visible in the dark.
- Xiao He and Mama approaching together and choosing to ask for help.
- Lantern Grandpa may be introduced only with warm, safe, welcoming cues.
...
- Compile result: `50-agent-work/story-lab/compiled-prompts/iep-pilot-001-p07-lantern-cottage-warm-light.json`.
- Semantic lint result: `50-agent-work/story-lab/semantic-lint-results/iep-pilot-001-p07-lantern-cottage-warm-light.json`.
...
Initial full-story order: 7 of 14. This order is planning metadata only and does not authorize generation.
...
Later QA must confirm the helper signal reads warm and safe, not mysterious or threatening.

## Repair Triggers / 修复触发条件

Repair if the cottage reads haunted, Grandpa reads uncanny, the child appears endangered, or source-like identifiers appear.
