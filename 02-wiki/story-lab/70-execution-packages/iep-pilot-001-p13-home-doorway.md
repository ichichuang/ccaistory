...
compile_result_ref: "50-agent-work/story-lab/compiled-prompts/iep-pilot-001-p13-home-doorway.json"
semantic_lint_result_ref: "50-agent-work/story-lab/semantic-lint-results/iep-pilot-001-p13-home-doorway.json"
...
Workflow F ready package plan for the p13 page illustration: safe arrival home and the positive safety lesson. No image asset is created by this card.

## Dependency Graph / 依赖图

- Required canonical cards: StoryProject `pilot-001`, Scene `scene-home-doorway`, Character cards `char-xiaohe` and `char-mama`, VisualStyle `vs-pilot-001-child-horror-notebook`, PromptRecipe `pr-pilot-001-child-horror-notebook`.
...
- Compile result: `50-agent-work/story-lab/compiled-prompts/iep-pilot-001-p13-home-doorway.json`.
- Semantic lint result: `50-agent-work/story-lab/semantic-lint-results/iep-pilot-001-p13-home-doorway.json`.
