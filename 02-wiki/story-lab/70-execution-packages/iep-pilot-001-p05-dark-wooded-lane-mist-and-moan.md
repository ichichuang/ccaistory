...
id: iep-pilot-001-p05-dark-wooded-lane-mist-and-moan
title_zh: pilot-001 p05 黑黑林路薄雾与风声图像执行包
title_en: pilot-001 p05 Dark Wooded Lane Mist and Moan Image Execution Package
status: draft
project_id: pilot-001
scene_id: scene-dark-wooded-lane
page_or_spread_range: p05
characters:
  - char-xiaohe
  - char-mama
character_ids:
...
compile_result_ref: "50-agent-work/story-lab/compiled-prompts/iep-pilot-001-p05-dark-wooded-lane-mist-and-moan.json"
semantic_lint_result_ref: "50-agent-work/story-lab/semantic-lint-results/iep-pilot-001-p05-dark-wooded-lane-mist-and-moan.json"
...
allowed_content:
  - "Low pale mist drifting across the road and a hollow fence-pipe foreshadowing an ordinary wind sound."
  - "Peak gentle fear, still child-safe and visually explainable."
forbidden_content:
  - "No horror, monster, ghost, gore, crime, adult content, occult or supernatural-punishment content."
  - "No mist, trees, windows, or shadows forming faces, bodies, ghosts, monsters, or threatening figures."
...
# pilot-001 p05 黑黑林路薄雾与风声图像执行包 / Dark Wooded Lane Mist and Moan Image Execution Package
...
Workflow F ready package plan for the p05 page illustration: pale low mist and an ordinary fence-pipe clue create the strongest but still safe fear beat. No image asset is created by this card.
...
- Low pale mist crossing the lane without forming any face, body, ghost, or creature.
- A hollow fence-pipe visible enough to support the later ordinary wind explanation.
- Xiao He shows mild fright; Mama stays close and calming.
...
- Compile result: `50-agent-work/story-lab/compiled-prompts/iep-pilot-001-p05-dark-wooded-lane-mist-and-moan.json`.
- Semantic lint result: `50-agent-work/story-lab/semantic-lint-results/iep-pilot-001-p05-dark-wooded-lane-mist-and-moan.json`.
...
Initial full-story order: 5 of 14. This order is planning metadata only and does not authorize generation.
...
Later QA must confirm the image remains spooky-cute, not horrific; mist and sound clues remain ordinary and explainable.

## Repair Triggers / 修复触发条件

Repair if the mist becomes a ghost, the pipe is missing, the scene implies haunting, or Xiao He appears traumatized.
