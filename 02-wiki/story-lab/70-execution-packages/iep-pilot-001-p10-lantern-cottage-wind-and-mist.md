...
id: iep-pilot-001-p10-lantern-cottage-wind-and-mist
title_zh: pilot-001 p10 守灯小屋风与薄雾解释图像执行包
title_en: pilot-001 p10 Lantern Cottage Wind and Mist Image Execution Package
status: draft
project_id: pilot-001
scene_id: scene-lantern-cottage
page_or_spread_range: p10
characters:
  - char-xiaohe
  - char-mama
...
compile_result_ref: "50-agent-work/story-lab/compiled-prompts/iep-pilot-001-p10-lantern-cottage-wind-and-mist.json"
semantic_lint_result_ref: "50-agent-work/story-lab/semantic-lint-results/iep-pilot-001-p10-lantern-cottage-wind-and-mist.json"
...
allowed_content:
  - "Ordinary explanation: wind through a hollow fence-pipe and low drifting mist."
  - "Warm cottage light and gentle relief; Tangerine may cameo as friendly."
forbidden_content:
...
# pilot-001 p10 守灯小屋风与薄雾解释图像执行包 / Lantern Cottage Wind and Mist Image Execution Package
...
Workflow F ready package plan for the p10 page illustration: wind in a hollow fence-pipe and low mist explain the earlier moan and pale shape. No image asset is created by this card.
...
- Hollow fence-pipe shown plainly as the source of wind sound.
- Low mist curling over open fields without forming figures.
- Warm lantern/cottage light and relieved, curious expressions.
- Tangerine may remain as a friendly cameo.
...
- Compile result: `50-agent-work/story-lab/compiled-prompts/iep-pilot-001-p10-lantern-cottage-wind-and-mist.json`.
- Semantic lint result: `50-agent-work/story-lab/semantic-lint-results/iep-pilot-001-p10-lantern-cottage-wind-and-mist.json`.
...
Initial full-story order: 10 of 14. This order is planning metadata only and does not authorize generation.
...
Later QA must confirm the wind and mist are ordinary natural causes and visually rhyme with the earlier dark-lane clues.

## Repair Triggers / 修复触发条件

Repair if mist becomes ghostlike, the pipe is unclear, the image suggests magic or haunting, or source-like identifiers appear.
