...
id: iep-pilot-001-p11-lantern-cottage-open-country
title_zh: pilot-001 p11 守灯小屋空旷田野解释图像执行包
title_en: pilot-001 p11 Lantern Cottage Open Country Image Execution Package
status: draft
project_id: pilot-001
scene_id: scene-lantern-cottage
page_or_spread_range: p11
characters:
  - char-xiaohe
  - char-mama
...
compile_result_ref: "50-agent-work/story-lab/compiled-prompts/iep-pilot-001-p11-lantern-cottage-open-country.json"
semantic_lint_result_ref: "50-agent-work/story-lab/semantic-lint-results/iep-pilot-001-p11-lantern-cottage-open-country.json"
...
allowed_content:
  - "Lantern Grandpa shows with a simple gesture or small map that they wandered from town lights into open country."
  - "Understanding, relief, warm light, and ordinary explanation."
forbidden_content:
  - "No horror, monster, ghost, gore, crime, adult content, occult or supernatural-punishment content."
  - "No scolding, punishment framing, danger spectacle, or magical explanation."
...
# pilot-001 p11 守灯小屋空旷田野解释图像执行包 / Lantern Cottage Open Country Image Execution Package
...
Workflow F ready package plan for the p11 page illustration: the final ordinary explanation that the dark felt strange because they had wandered away from the town lights. No image asset is created by this card.
...
- Lantern Grandpa using a simple pointing gesture or small map.
- Open fields beyond the cottage, town lights or lit road implied at a safe distance.
- Xiao He understanding the ordinary cause and feeling relieved.
...
- Compile result: `50-agent-work/story-lab/compiled-prompts/iep-pilot-001-p11-lantern-cottage-open-country.json`.
- Semantic lint result: `50-agent-work/story-lab/semantic-lint-results/iep-pilot-001-p11-lantern-cottage-open-country.json`.
...
Initial full-story order: 11 of 14. This order is planning metadata only and does not authorize generation.
...
Later QA must confirm the explanation is ordinary, gentle, and non-punitive; Grandpa remains safe and kind.

## Repair Triggers / 修复触发条件

Repair if the scene introduces punishment, danger spectacle, magical explanations, or source-like identifiers.
