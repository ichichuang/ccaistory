...
## 编译前硬阻断
asset_type 与 asset_id 不匹配；R00 含人物/场景/道具集合/符号表；R01 含完整剧情；R02 含主线故事推进；S 页含长手写正文；P01 不是 9:16；缺 reference_dependencies、visual_center、density_range 或 composition_mode。
